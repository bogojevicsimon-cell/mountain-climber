  ...
  return (
    <div className="min-h-screen bg-hero">
      <div className="mx-auto max-w-3xl px-6 py-12">
        <h1 className="text-center text-4xl font-bold sm:text-5xl text-glow">Build your mountain</h1>
        <p className="mt-3 text-center text-muted-foreground">This shape will follow you every day until you crush it.</p>

        <div className="mt-10 rounded-2xl border border-border bg-card p-8 shadow-dramatic">
          <form onSubmit={submit} className="space-y-8">
            <div className="space-y-2">
              <Label htmlFor="habit" className="text-base">What habit are you quitting?</Label>
            ...
            <div className="space-y-3">
              <Label className="text-base">How heavy is this habit?</Label>
